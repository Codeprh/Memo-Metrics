package noah.memo.memoframework.utils;
...
public class FastDateUtils extends DateUtils {
    ...
    public static Date isUTCDate(String dateStr) {
        ...
        String newDateStr = StringUtils.trimToEmpty(dateStr);
    ...
    public static Date getToday() {
        Date date = new Date();
        //格式为 2017-07-24 00:00:00
        String strToDay = getDateFormat(FastDateFormat.DATE).format(date) + " 00:00:00";
    ...
    public static Date missDatess(Date date) {
        ...
        if ("00".equals(second)) {
            ...
            String strToDay = FastDateUtils.getDateFormat(FastDateFormat.DATE).format(date) + " " + FastDateUtils.getDateFormat(FastDateFormat.MINI_TIME).format(date) + ":00";
