package noah.memo.memoframework.bean.request;
...
public class ReqData {
    ...
    // 抛异常信息及code
    private static final int EXCEPTION_CODE = RspStatus.PARAM_MISS.status;
    private static final String EXCEPTION_MSG = RspStatus.PARAM_MISS.msg;
    ...
    public int getAsInt(String key) {
        try {
            ...
            throw new BusinessException(EXCEPTION_CODE, EXCEPTION_MSG);
        }
    }
